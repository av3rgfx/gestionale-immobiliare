...
| File | Contenuto |
|---|---|
| `C1_verdetto.md` | Architettura e stack tecnico, JARVIS, backup, dev/test |
| `C2_verdetto.md` | Skill e regole fisse (superpowers, ponytail, impeccable, llm-council) |
| `C3_verdetto.md` | Modulo documentale: template, anteprima, privacy |
| `C4_verdetto.md` | Scadenze locazioni 3+2: doppio trigger, email, ciclo chiuso |

...
## DECISIONI NON NEGOZIABILI (già validate da 6 consigli tecnici — si applicano, non si ridiscutono)
...
1. **Verifica del repo GitHub.** Il repo `gestionale-immobiliare` dovrebbe già esistere sul Mac e su GitHub con i file della harness (l'ho creato seguendo `00_LEGGIMI.md`). Guidami a verificare che ci siano tutti i file (00–07 e la cartella `06_PROMPT_SPRINT/`) e che il push funzioni. Se manca qualcosa, completiamolo prima di proseguire.
